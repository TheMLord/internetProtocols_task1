...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\mikle\PycharmProjects\InternetProtocols_tracing\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\mikle\PycharmProjects\InternetProtocols_tracing\venv\Scripts\deactivate.nu'
